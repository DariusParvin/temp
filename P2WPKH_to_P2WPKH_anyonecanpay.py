...
sighash = bytes.fromhex("8300 0000")
sighash_type_flag = bytes.fromhex("83")
...
hashPrevOuts = bytes.fromhex("00000000000000000000000000000000")
# hashSequence = dSHA256(sequence)
hashSequence = bytes.fromhex("00000000000000000000000000000000")
...
hashOutputs = bytes.fromhex("00000000000000000000000000000000")
